        ...
        <div class="flow-steps">
          ...
          <div class="flow-step">
            ...
            <div>
              ...
              <p style="color: var(--text-secondary)">
                Каждые 30 минут (или вручную) анализатор сравнивает новые
          ...
          <div class="flow-step">
            ...
            <div>
              ...
              <p style="color: var(--text-secondary)">
                ...
                все <code>is_undervalued = true</code> объекты за последние
                сутки и отправляет email через SMTP. Если таких объектов нет —
