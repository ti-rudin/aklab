<template>
  <div>
    <div class="flex items-center justify-between mb-6">
      <h2 class="text-lg font-semibold" style="color: var(--text-main)">Эталоны стоимости ₽/м²</h2>
    </div>

    <!-- Форма добавления -->
    <div class="rounded-xl p-6 border mb-8" style="background: var(--bg-elevated); border-color: var(--border-subtle)">
      <h3 class="text-base font-semibold mb-4" style="color: var(--text-main)">Новый эталон</h3>
